...
-   **Class:** Indica si la seta es comestible (e) o venenosa (p). Esta variable constituye el criterio principal, ya que el objetivo es identificar características asociadas a la toxicidad.

-   **Odor:** Describe el tipo de olor de la seta (almendrado, anís, desagradable, picante, sin olor, entre otros). Se trata de una variable categórica con múltiples niveles, representando un rasgo sensorial potencialmente discriminante entre especies.

-   **Bruises:** Indica si la seta se magulla al manipularla (t = sí, f = no). Esta característica fisiológica puede diferenciar setas tóxicas de las no tóxicas.
...
Los resultados obtenidos a partir de los tests de Chi-cuadrado de independencia indican que, en ambas comparaciones, los valores p son menores que 0,05, lo que implica el rechazo de la hipótesis nula (H₀) en los dos casos.
